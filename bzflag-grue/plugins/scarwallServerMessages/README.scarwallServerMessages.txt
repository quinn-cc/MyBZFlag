BZFlag Server Plugin: scarwallServerMessages
================================================================================
...
scarwallServerMessages directory to a new name, and then manually replace scarwallServerMessages
...
This plugin takes no optional arguments, so load it with:
  -loadplugin scarwallServerMessages
...
To load the plugin with specific settings, use the format:
  -loadplugin scarwallServerMessages,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin scarwallServerMessages,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin scarwallServerMessages,<configfilename>
For example:
  -loadplugin scarwallServerMessages,/path/to/my/sampleplugin.cfg
