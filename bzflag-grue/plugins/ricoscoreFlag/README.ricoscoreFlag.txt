BZFlag Server Plugin: ricoscoreFlag
================================================================================
...
ricoscoreFlag directory to a new name, and then manually replace ricoscoreFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin ricoscoreFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin ricoscoreFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin ricoscoreFlag,<configfilename>
For example:
  -loadplugin ricoscoreFlag,/path/to/my/sampleplugin.cfg
