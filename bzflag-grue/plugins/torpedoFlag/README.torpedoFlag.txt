BZFlag Server Plugin: torpedoFlag
================================================================================
...
torpedoFlag directory to a new name, and then manually replace torpedoFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin torpedoFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin torpedoFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin torpedoFlag,<configfilename>
For example:
  -loadplugin torpedoFlag,/path/to/my/sampleplugin.cfg
