...
lookup directory to a new name, and then manually replace lookup
...
To load the plugin with specific settings, use the format:
  -loadplugin lookup,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin lookup,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin lookup,<configfilename>
For example:
  -loadplugin lookup,/path/to/my/sampleplugin.cfg
