BZFlag Server Plugin: shittyFlags
================================================================================
...
shittyFlags directory to a new name, and then manually replace shittyFlags
...
To load the plugin with specific settings, use the format:
  -loadplugin shittyFlags,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin shittyFlags,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin shittyFlags,<configfilename>
For example:
  -loadplugin shittyFlags,/path/to/my/sampleplugin.cfg
