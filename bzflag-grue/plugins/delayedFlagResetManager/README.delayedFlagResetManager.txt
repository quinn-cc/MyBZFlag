BZFlag Server Plugin: delayedFlagResetManager
================================================================================
...
delayedFlagResetManager directory to a new name, and then manually replace delayedFlagResetManager
...
This plugin takes no optional arguments, so load it with:
  -loadplugin delayedFlagResetManager
...
To load the plugin with specific settings, use the format:
  -loadplugin delayedFlagResetManager,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin delayedFlagResetManager,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin delayedFlagResetManager,<configfilename>
For example:
  -loadplugin delayedFlagResetManager,/path/to/my/sampleplugin.cfg
