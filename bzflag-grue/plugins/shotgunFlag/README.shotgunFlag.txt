BZFlag Server Plugin: shotgunFlag
================================================================================
...
shotgunFlag directory to a new name, and then manually replace shotgunFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin shotgunFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin shotgunFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin shotgunFlag,<configfilename>
For example:
  -loadplugin shotgunFlag,/path/to/my/sampleplugin.cfg
