BZFlag Server Plugin: lowGravityFlag
================================================================================
...
lowGravityFlag directory to a new name, and then manually replace lowGravityFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin lowGravityFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin lowGravityFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin lowGravityFlag,<configfilename>
For example:
  -loadplugin lowGravityFlag,/path/to/my/sampleplugin.cfg
