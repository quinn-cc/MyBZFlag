BZFlag Server Plugin: shotAssigner
================================================================================
...
shotAssigner directory to a new name, and then manually replace shotAssigner
...
To load the plugin with specific settings, use the format:
  -loadplugin shotAssigner,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin shotAssigner,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin shotAssigner,<configfilename>
For example:
  -loadplugin shotAssigner,/path/to/my/sampleplugin.cfg
