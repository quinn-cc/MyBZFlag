...
wishFlag directory to a new name, and then manually replace wishFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin wishFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin wishFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin wishFlag,<configfilename>
For example:
  -loadplugin wishFlag,/path/to/my/sampleplugin.cfg
