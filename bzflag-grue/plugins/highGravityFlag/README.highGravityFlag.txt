BZFlag Server Plugin: highGravityFlag
================================================================================
...
highGravityFlag directory to a new name, and then manually replace highGravityFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin highGravityFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin highGravityFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin highGravityFlag,<configfilename>
For example:
  -loadplugin highGravityFlag,/path/to/my/sampleplugin.cfg
