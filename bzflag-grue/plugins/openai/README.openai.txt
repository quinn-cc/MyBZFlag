...
openai directory to a new name, and then manually replace openai
...
To load the plugin with specific settings, use the format:
  -loadplugin openai,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin openai,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin openai,<configfilename>
For example:
  -loadplugin openai,/path/to/my/sampleplugin.cfg
