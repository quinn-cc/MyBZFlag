BZFlag Server Plugin: observerHandler
================================================================================
...
observerHandler directory to a new name, and then manually replace observerHandler
...
To load the plugin with specific settings, use the format:
  -loadplugin observerHandler,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin observerHandler,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin observerHandler,<configfilename>
For example:
  -loadplugin observerHandler,/path/to/my/sampleplugin.cfg
