BZFlag Server Plugin: ctfOverseer
================================================================================
...
ctfOverseer directory to a new name, and then manually replace ctfOverseer
...
To load the plugin with specific settings, use the format:
  -loadplugin ctfOverseer,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin ctfOverseer,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin ctfOverseer,<configfilename>
For example:
  -loadplugin ctfOverseer,/path/to/my/sampleplugin.cfg
