BZFlag Server Plugin: gruesTurretDefenseMaster
================================================================================
...
gruesTurretDefenseMaster directory to a new name, and then manually replace gruesTurretDefenseMaster
...
This plugin takes no optional arguments, so load it with:
  -loadplugin gruesTurretDefenseMaster
...
To load the plugin with specific settings, use the format:
  -loadplugin gruesTurretDefenseMaster,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin gruesTurretDefenseMaster,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin gruesTurretDefenseMaster,<configfilename>
For example:
  -loadplugin gruesTurretDefenseMaster,/path/to/my/sampleplugin.cfg
